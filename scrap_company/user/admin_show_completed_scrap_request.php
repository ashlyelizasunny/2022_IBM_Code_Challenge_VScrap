            ...
            <div class="col-lg-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Scrapped Vehicles</h6>
                </div>
                <div class="card-body">
...
$qry="SELECT * FROM scrap_request s join company c on(c.cmp_id = s.cmp_id) where   status='completed'";
